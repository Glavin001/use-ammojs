...
import { BodyType, Physics, ShapeType, SoftBodyType, useSoftBody, PhysicsStats, useRigidBody, useSingleBodyConstraint, ConstraintType, useTwoBodyConstraint, AmmoDebugConstants, AmmoDebugOptions } from 'use-ammojs'
...
function PhysicalBall({ position, pressure }: any = {}) {
...
PhysicalCylinder.displayName = 'PhysicalCylinder';
