...
function getPointInBetweenByPerc(pointA: THREE.Vector3, pointB: THREE.Vector3, percentage: number) {
...
export function fakeHand(handNum: number) {
...
/*
export function fakeHand2(handNum: number) {
    const scale = 2
    const initPos =
        handNum === 0
            ? {
